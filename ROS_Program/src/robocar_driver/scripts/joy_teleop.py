...
class JoyTeleop:
	...
	def buttonCallback(self, joy_data):
		if(joy_data.buttons[4] == 1):
			self.velocity.linear.x = self.x_speed_scale * joy_data.axes[1]
			self.velocity.linear.y = self.y_speed_scale * joy_data.axes[0]
			self.velocity.angular.z = self.w_speed_scale * joy_data.axes[3]
		else:
